...
if __name__ == '__main__':
    ...
    quantizer = QDQQuantizer(
        ...
        {"ForceQuantizeNoInputCheck": True, "MatMulConstBOnly": False ,"WeightSymmetric": False, 'ActivationSymmetric' : True, 'AddQDQPairToWeight' : True, 'OpTypesToExcludeOutputQuantization': op_types_to_quantize, 'DedicatedQDQPair': True, 'QDQOpTypePerChannelSupportToAxis': {'MatMul': 1} }) #extra_options
